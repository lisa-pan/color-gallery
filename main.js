...
const accordion = document.getElementsByClassName("header-box");
...
function showNextSlide() {
  ...
  if (
    currentSlideIndex <
    Object.keys(dogObj).filter(function (key) {
      // siehe unten
...
const intensityText = {
  ...
  slide1:
    "<p> Der Farbton des rotblonden Phäomelanin-Pigments kann stark variieren. So sieht man zum Beispiel beim blonden Labrador und Golden Retriever Farbtöne von fast weiß bis “fox red”, vor allem in Jagdlinien.</p>",
  img2: "dogbreed-pics/samoyed.jpg",
  slide2:
    "<p> Tatsächlich sind die meisten weißen Hunderassen gar nicht “echt” weiß, das heißt ihnen fehlt kein Pigment, sondern sie haben einfach sehr stark verdünntes Phäomelanin. Malteser, Westies, Bichons, weiße Pudel, und viele andere Rassen sind also einfach nur wasserstoffblond. Tatsächlich findet man in diesen Rassen oft Hunde mit hellem Cremeton, wie bei den Samojeden im Bild. </p>",
